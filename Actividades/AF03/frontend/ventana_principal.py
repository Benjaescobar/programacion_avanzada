...
class VentanaPrincipal(QMainWindow):
    ...
    def crear_botones(self):
        ...
        self.tarea1 = QPushButton('&Tarea 1', self)
        self.tarea2 = QPushButton('&Tarea 2', self)
        self.tarea1.resize(self.tarea1.sizeHint())
        self.tarea2.resize(self.tarea2.sizeHint())
        self.tarea1.clicked.connect(self.boton_tarea_clickeado)
        self.tarea2.clicked.connect(self.boton_tarea_clickeado)

        vbox.addWidget( self.tarea1)
        vbox.addWidget( self.tarea2)
        # No modificar ->
    ...
    def tarea_terminada(self, info_tarea):
        ...
        # Completar
        if numero_tarea == 1:
            self.tarea1.setEnabled(False)
            self.contador_tareas.setText("Tareas terminadas " + str(tareas_terminadas) + "/2")
        elif numero_tarea == 2:
            self.tarea2.setEnabled(False)
            self.contador_tareas.setText("Tareas terminadas " + str(tareas_terminadas) + "/2")
